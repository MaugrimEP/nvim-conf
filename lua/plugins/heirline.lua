return {
  ...
  opts = function(_, opts)
    ...
    opts.statusline = { -- statusline
      ...
      status.component.file_info { filename = { fallback = "Empty" }, filetype = { padding = { left = 1 } } },
      ...
      status.component.file_info {
        ...
        filename = {
          ...
          icon = { kind = "FolderClosed", padding = { right = 1 } },
        },
        filetype = false,
        file_modified = false,
        file_read_only = false,
        surround = { separator = "right", condition = false },
      },
